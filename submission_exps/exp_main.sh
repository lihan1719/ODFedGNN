...
# GRU (centralized, 63K)
python main.py --dataset NYC_bike --seed 42 --model_name NodePredictorOD --base_model_name GRUSeq2Seq --batch_size 64 --hidden_size 100 --gru_num_layers 1 --gpus 0, --use_curriculum_learning

# ODFedGNN(64K + 1M)
python main.py --dataset NYC_bike --seed 42 --model_name ODFedGNN --base_model_name GRUSeq2SeqWithGraphNet --batch_size 128 --server_batch_size 48 --hidden_size 64 --suffix single --use_curriculum_learning --mp_worker_num 1 --sync_every_n_epoch 1 --server_epoch 20 --gcn_on_server --gpus 0, --max_epochs 200 --early_stop_patience 20 --gru_num_layers 1
...
#测试
python main.py --dataset NYC_bike --seed 42 --model_name ODFedGNN --base_model_name GRUSeq2SeqWithGraphNet --batch_size 128 --server_batch_size 48 --hidden_size 64 --suffix single --use_curriculum_learning --mp_worker_num 1 --sync_every_n_epoch 1 --server_epoch 20 --gcn_on_server --gpus 0, --max_epochs 200 --early_stop_patience 20 --gru_num_layers 1 --notrain --load_test_ckpt_path 'artifacts/fedgnn/igtrp76m/checkpoints/epoch=15.ckpt'